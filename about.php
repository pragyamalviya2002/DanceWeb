...
<body>
    ...
    <div class="address">
                <h3>Contact us</h3><br>
                <i class="bi bi-house-door"></i>       <b class="ps-2">Address:</b> CTO Road <br> Bairagarh Bhopal,<br> Madhya Pradesh 462030<br><br><i class="bi bi-envelope "></i> <b class="ps-2">E-mail :</b> mail@gmail.com<br> <i78>
            </div>
    ...
    echo "<footer>";
        echo '<div class="footer">';
           echo" Copyright ©".$date=date('Y')."  - www.dance+.com. All Rights Reserved Designed and Developed by Pragya Malviya";
        echo "</div>";
    echo "</footer>";
    ?>
